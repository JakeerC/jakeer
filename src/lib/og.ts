 ...
 * @param logoWidth - The width of the logo. @default 480
 * @param logoHeight - The height of the logo. @default 480
...
export function og({
  ...
  return `${ogBaseURL}/api/${ogType}?articleType=${articleType}&banner=${encodedBanner}&templateTitle=${templateTitle}&theme=${theme}`;
}
